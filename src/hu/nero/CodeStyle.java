...
public class CodeStyle
{
  public static void main(String[] args)
  {
    ...
    //
    // Стиль ONE_TWO - может быть использован только для static final и ENUM
    ...
    // Между объявлений атрибутов и конструктором должна быть пустая строка
...
//        }
    ...
    // +,-,*,%,/,=, ==,!=,&&,|| - должны оборачиваться пробелами
    // Правильно:
    // int age = 1 + 1;
    // Неправильно:
    // int age=1+1;
...
//        System.out.println("llll");
    ...
    int ageShopper = 18;
    //
    // Для комментирования класса используйте конструкцию /** */ (пример над этим классом)
  }
}
